...
<details>
<summary>16. Разница между векторным и расторным изображением?</summary>
...
<details>
<summary>17. Для чего используют data-атрибуты?</summary>
...
<details>
<summary>18. Разница между `script`, `script async` и `script defer`? (Асинхронный и отложенный)</summary>
