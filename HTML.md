...
<details>
<summary> 1. Что описывается в тэге head?</summary>
...
<details>
<summary> 2. Почему хорошей практикой считается располагать link для подключения CSS стилей внутри тэга head, а script для подключения JS ставить перед закрывающим тегом body</summary>
...
<details>
<summary> 3. Что такое мета-тэги? </summary>
...
<details>
<summary> 4. Расскажите о meta-теге с name="viewport"?</summary>
...
<details>
<summary>1. Что такое инлайновый стиль? Можно ли его переопределить?</summary>
...
<details>
<summary>2. Есть ли у HTML – элементов свои дефолтные специфичные стили?</summary>
...
<details>
<summary>3. Что такое семантика? Какие семантические тэги вы знаете?</summary>
...
<details>
<summary>4. Типы списков в HTML?</summary>
...
<details>
<summary>5. Для чего используются тэги tr, th, td?</summary>
...
<details>
<summary>6. Для чего используется элемент datalist? </summary>
...
<details>
<summary>7. Какая разница между тэгами `strong` и `em` и `b` и `i`?</summary>
...
### Validation
<details>
<summary>. 1. Что такое валидация? И какие типы проверок HTML документа вы знаете?</summary>
...
<details>
<summary>1. Представьте HTML5 как открытую веб-платформу. Из каких блоков состоит HTML5?</summary>
...
<details>
<summary>2. Разница между векторным и расторным изображением?</summary>
...
<summary>3. Представьте HTML5 как открытую веб-платформу. Из каких блоков состоит HTML5?</summary>
...
<details>
<summary> 1. Какой тег использовать для того, чтобы сверстать кнопку?</summary>
...
<details>
<summary>2. Как семантически правильно сверстать картинку с подписью?</summary>
...
<details>
<summary> 3. Как семантически верно сверстать навигационное меню?</summary>
<img src='./assets/4.png'/>
</details>


<details>
<summary> 4. Как можно скрыть элемент разметки не используя CSS и JS?</summary>
